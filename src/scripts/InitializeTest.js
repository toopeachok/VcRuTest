        ...
        <div class="test-results-page__content">
          ...
          <a class="social-links" href="#!">
            <span class="facebook-link">
              <img src="../docs/images/social-links-images/facebook-logo.svg" alt="">
            </span>
          </a>
          <a class="social-links" href="#!">
            <span class="vk-link">
              <img src="../docs/images/social-links-images/vk-social-logotype.svg" alt="">
            </span>
          </a>
          <a class="social-links" href="#!">
            <span class="twitter-link">
              <img src="../docs/images/social-links-images/twitter-logo-silhouette.svg" alt="">
            </span>
          </a>
